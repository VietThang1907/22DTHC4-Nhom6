        ...
        <table className={combinedStyles.table}>          <thead>
          ...
          <tbody>            {loading ? (
              ...
              movies.map((movie) => (                <tr 
                ...
                >
                  <td onClick={() => setDetailModal({ isOpen: true, movie })} className={combinedStyles.idColumn}>{movie._id}</td>
                  ...
                  <td onClick={() => setDetailModal({ isOpen: true, movie })} className={combinedStyles.infoColumn}>
                    <div className={combinedStyles.movieMetaInfo}>                      <div className={styles.ratingStars}>
